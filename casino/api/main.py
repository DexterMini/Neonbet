...
from casino.api.routes import auth_router, bets_router, wallet_router, admin_router, payments_router, responsible_gambling_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(responsible_gambling_router, prefix="/api/v1")
