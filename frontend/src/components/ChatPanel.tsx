        ...
        <div className="px-3 py-2 border-t border-border/60">
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-accent-cyan/10 text-accent-cyan text-[11px] font-semibold border border-accent-cyan/20 hover:bg-accent-cyan/15 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-accent-amber/10 text-accent-amber text-[11px] font-semibold border border-accent-amber/20 hover:bg-accent-amber/15 transition-colors"
            >
